...
from src.endpoints.report_event_endpoints import init_api_report_event_endpoints
from src.security import JWTService


def init_api_endpoints(api_blueprint: Blueprint, jwt_service: JWTService, db_client: SoflyDbClient, ai_model):
    ...
    init_api_report_event_endpoints(api_blueprint, jwt_service, ai_model)
